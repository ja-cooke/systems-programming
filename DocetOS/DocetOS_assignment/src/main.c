...
int main(void) {
	...
	static OS_TCB_t TCB1 = {.priority = 1};
	...
	static OS_TCB_t TCB7 = {.priority = 1};
	static OS_TCB_t TCB8 = {.priority = 0};
	static OS_TCB_t TCB9 = {.priority = 1};
	static OS_TCB_t TCB10 = {.priority = 0};

	/* Initialise the TCBs using the two functions above */
	OS_initialiseTCB(&TCB1, stack1+128, sleepTest1, NULL);
	...
	OS_initialiseTCB(&TCB7, stack7+128, sleepTest1, NULL);
	OS_initialiseTCB(&TCB8, stack8+128, sleepTest2, NULL);
	OS_initialiseTCB(&TCB9, stack9+128, sleepTest1, NULL);
	OS_initialiseTCB(&TCB10, stack10+128, sleepTest2, NULL);
